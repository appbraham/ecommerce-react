    ...
    <div className="bg-gray-200 flex flex-col items-center px-4">
      <div className="max-w-[1440px] flex flex-col gap-4 items-center  md:flex-row ">
        <div className="flex flex-col gap-6 py-6 flex-1">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 lg:justify-start lg:flex-nowrap lg:gap-16 lg:mt-6">
        ...
        <img className="flex-1" src={heroImage} alt="Hero Image" />
      </div>
    </div>
  )
}
